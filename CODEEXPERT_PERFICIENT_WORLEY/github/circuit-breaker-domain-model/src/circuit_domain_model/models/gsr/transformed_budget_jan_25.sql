...
{{
    config(
        ...
        custom_location=target.location ~ 'transformed_budget_jan_25/',
...
select
  'Jan' as month,
  '2025' as year,
  CAST('2025-01-01 00:00:00' as TIMESTAMP) as budget_timestamp,
  CASE
    WHEN UPPER(budget_jan_25__bud__input_currency) = 'NAN' THEN NULL
    ELSE budget_jan_25__bud__input_currency
  ...
  CASE
    WHEN UPPER(budget_jan_25__actuals) = 'NAN' THEN NULL
    ELSE budget_jan_25__actuals
