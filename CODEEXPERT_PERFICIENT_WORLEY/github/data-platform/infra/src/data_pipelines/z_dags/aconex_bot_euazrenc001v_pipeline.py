...
dag_id = "aconex_bot_euazrenc001v_pipeline"
instance_name = "euazrenc001v"
...
with DAG(
    ...
    tags=["supplier server", "euazrenc001v"],
    ...
    csv_parsing_task = GlueJobOperator(
        ...
        script_args = {
            ...
            "--connector_file_path": f"document_control/aconex/supplier_report/raw/instance_name={instance_name}/{batch_run_start_time_str}_UTC/",
    ...
    raw_curated_generic = GlueJobOperator(
                ...
                script_args={
                    ...
                    "--metadata_type": f"curated#aconex#supplier_report#job#iceberg",
                    "--start_date": execution_date,
                    "--end_date": execution_date,
