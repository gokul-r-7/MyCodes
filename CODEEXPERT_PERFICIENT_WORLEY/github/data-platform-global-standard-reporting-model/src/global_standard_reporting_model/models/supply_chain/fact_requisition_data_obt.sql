...
(
    SELECT DISTINCT
        CAST(proj_no as integer) as project_no,
        ...
        proj_planned_tmr_hdr_id	as requisition_no,
        po_number	,
        deliv_deadline	as ros_date,
        lead_time ,
        sub_project	,
        cf_new_float as float_new,
        ...
        milestone_comment	,
        cast(calc_seq as integer) as milestone_sequence,
        remarks	as comment,
        contract_owner	 ,
        contract_holder	,
        project_region	,
    ...
    FROM
        {{ source('supply_chain_dim', 'transformed_cext_w_psr_st_api_dh') }}
)