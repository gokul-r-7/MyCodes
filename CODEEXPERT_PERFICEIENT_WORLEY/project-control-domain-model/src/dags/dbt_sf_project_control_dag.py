...
payload = json.dumps({
          "dag_name": "dbt_project_control_dag",
...
profile_config = ProfileConfig(
    ...
    profile_mapping=RedshiftUserPasswordProfileMapping(
        ...
        profile_args={"schema": "snowflake_model", "user": username, "password": password}
    ),
)
...
with DAG(
    dag_id="dbt_sf_project_control_dag",
    ...
    audit_dbt_task >> dbt_sf_task >> dbt_check >> sns_notification_for_failure_for_modelling_task_group >> apply_redshift_permissions >> run_gsr_models_dag >> sns_notification_for_failure_for_other_tasks
    #[dbt_task, apply_redshift_permissions] >> run_gsr_models_dag >> sns_notification_for_failure
