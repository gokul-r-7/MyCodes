...
document_control_aconex_project_list = [
    "1342181257","1342181268","1342181262","1342181165","1342181268","1342181257","1342181262"
]
default_args = {
    "owner": "worley",
...
with DAG(
    ...
    tags=["document_control_aconex","document_control_aconex_US"],
    ...
    @task_group(group_id="doc_control_run_glue_jobs")
    ...
    @task_group(group_id="mail_sourcing_entities")
    ...
    @task_group(group_id="mail_doc_sourcing_entities")
    ...
    @task_group(group_id=f"mail_curation")
    ...
    mail_sourcing_entity.expand(ProjectId=document_control_aconex_project_list) >> mail_doc_sourcing_entity.expand(ProjectId=document_control_aconex_project_list) >> raw_crawler >> mail_raw_to_curated()
    Project_job >> doc_control_run_glue_jobs.expand(ProjectId=document_control_aconex_project_list) >> raw_crawler
    UserDirectory_job >> raw_crawler >> raw_to_curated() >> run_document_control_models_dag
