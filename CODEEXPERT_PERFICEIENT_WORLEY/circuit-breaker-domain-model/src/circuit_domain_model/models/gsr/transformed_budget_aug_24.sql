...
{{
    config(
        ...
        custom_location=target.location ~ 'transformed_budget_aug_24/',
...
select
  'Aug' as month,
  '2024' as year,
  CAST('2024-08-01 00:00:00' as TIMESTAMP) as budget_timestamp,
  CASE
    WHEN UPPER(budget_aug_24__bud__input_currency) = 'NAN' THEN NULL
    ELSE budget_aug_24__bud__input_currency
  ...
  CASE
    WHEN UPPER(budget_aug_24__actuals) = 'NAN' THEN NULL
    ELSE budget_aug_24__actuals
