...
payload = json.dumps({
          ...
          "obt_name": ["engineering_document_register_fact","review_status_fact"], 
          "db": "global_standard_reporting",
          "dag_name": "dbt_global_standard_reporting_document_control_dag_v2"
          })
...
profile_config = ProfileConfig(
    ...
    profile_mapping=RedshiftUserPasswordProfileMapping(
        ...
        profile_args={"schema": "document_control",
...
with DAG(
    dag_id="dbt_global_standard_reporting_document_control_dag_v2",
