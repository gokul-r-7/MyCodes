...
secret_name = dag_config["circuit_breaker"]

payload = json.dumps({
          "dag_name": "dbt_circuit_breaker_dag",
...
#     target_name="circuit_breaker",
#     profile_mapping=RedshiftUserPasswordProfileMapping(
#         conn_id="redshift_circuit_breaker_connection",
#         profile_args={"schema": "domain_integrated_model",
#                       "user": username, "password": password}
#     ),
# )
DBT_PROJECT_PATH = os.environ.get("DBT_CIRCUIT_BREAKER_PROJECT_PATH", "/usr/local/airflow/dags/dbt").strip()
...
with DAG(
    dag_id="dbt_circuit_breaker_dag",
    start_date=datetime(2025, 1, 1),
    schedule=[circuit_breaker_dataset],
    catchup=False,
    tags=["dbt"],
):
