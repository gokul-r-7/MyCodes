...
profile_config = ProfileConfig(
    ...
    profile_mapping=RedshiftUserPasswordProfileMapping(
        ...
        profile_args={"schema": "snowflake_model", 
...
with DAG(
    dag_id=f"dbt_sf_supply_chain_{environment}_dag",
    ...
    audit_dbt_task >> sf_dbt_task >> dbt_check >> sns_notification_for_failure_for_modelling_task_group >> apply_redshift_permissions >> sns_notification_for_failure_for_other_tasks
    #[sf_dbt_task, apply_redshift_permissions] >> run_gsr_models_dag >> sns_notification_for_failure