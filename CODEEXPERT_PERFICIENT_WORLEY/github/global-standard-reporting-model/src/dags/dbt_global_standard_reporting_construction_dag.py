...
payload = json.dumps({
          "domain": "construction", 
          "obt_name": ["iwp_main_skyline_dashboard_obt","iwp_skyline_dashboard_obt","iwp_by_discipline","cumulative_qty_by_discipline","iwp_daily_progress_comparison_hours_obt","daily_progress_cumulative_qty_obt","wwp_8_week_lookahead","wfp_progress_status","weekly_work_plan","weekly_summary_hours"], 
          "target_database": "global_standard_reporting",
          "dag_name": "dbt_global_standard_reporting_construction_dag"
          })
...
profile_config = ProfileConfig(
    ...
    profile_mapping=RedshiftUserPasswordProfileMapping(
        ...
        profile_args={"schema": "construction",
...
construction_dataset = Dataset("//construction/domain_integrated_model/global_standard_reporting")
project_control_dataset = Dataset("//project_control/domain_integrated_model/global_standard_reporting")

with DAG(
    dag_id="dbt_global_standard_reporting_construction_dag",
    start_date=datetime(2024, 9, 18),
    #schedule_interval="@once",
    schedule=(construction_dataset | project_control_dataset),
    catchup=False,
