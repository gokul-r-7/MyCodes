...
payload = json.dumps({
    ...
    "dag_name": "dbt_global_standard_reporting_circuit_breaker_dag"
    })
...
profile_config = ProfileConfig(
    ...
    profile_mapping=RedshiftUserPasswordProfileMapping(
        ...
        profile_args={"schema": "circuit_breaker",
...
#circuit_gsr_dataset = Dataset("//circuit_breaker/domain_integrated_model/global_standard_reporting")

with DAG(
    dag_id="dbt_global_standard_reporting_circuit_breaker_dag",
    start_date=datetime(2025, 1, 1),
    schedule_interval="@once",
    #schedule=[circuit_gsr_dataset],
    catchup=False,
    tags=["dbt"],
):
