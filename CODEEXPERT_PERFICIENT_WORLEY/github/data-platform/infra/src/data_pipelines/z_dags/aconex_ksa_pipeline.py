...
# Dataset for Upstream Sourcing for KSA region
...
with DAG(
    ...
    @task_group(group_id="run_glue_jobs_ksa")
    ...
    run_document_control_curation_dag = BashOperator(
        task_id='run_document_control_ksa_curation_dag',
