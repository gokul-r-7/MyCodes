...
SELECT
    ...
    discipline,
    MAX(milestone_planned_date) as po_planned_date,
    MAX(milestone_forecast_date) as po_forecast_date
FROM
(
        SELECT
            *,
...
WHERE
    grouped_milestone_code = 'PO ISSUED' 
    and requistion_no is not null
    and flag = 0
GROUP BY
    project_code,
    requistion_no,
