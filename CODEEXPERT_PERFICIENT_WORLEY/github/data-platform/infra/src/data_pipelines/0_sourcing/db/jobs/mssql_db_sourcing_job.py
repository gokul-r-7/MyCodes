...
def main():
    ...
    "==================Setting up the Spark and Glue Context ============"
        ...
        print (f"Partition JOb Column : {jobConfig.db_parameter.partition_column}")
        print (f"Partition JOb Column : {partition_column_value}")
        print (f"Type of Partition Column : {type(jobConfig.db_parameter.partition_column)}")
        print (f"Type of Partition Column : {partition_column_value}")
        ...
        print(f"tbl_query : {tbl_query}")
        print(f"min_max_tbl_query : {min_max_tbl_query}")
        print(f"db_host_url : {db_host_url}")
        print(f"user : {user}")
        print(f"sample_tbl_query :{sample_tbl_query}")
        ...
        print(f"Total incremental records to be processed :{row_count}")
        ...
        if row_count > 0:
            ...
            print("Writting source data to S3")
            src_data_frame.write.mode("append").parquet(s3_output_path)

            print("Creating sampling dataframe")
            ...
            print(f"Writting sampling data")
