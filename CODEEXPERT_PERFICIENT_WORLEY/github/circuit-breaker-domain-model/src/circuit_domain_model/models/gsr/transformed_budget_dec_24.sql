...
{{
    config(
        ...
        custom_location=target.location ~ 'transformed_budget_dec_24/',
...
select
  'Dec' as month,
  '2024' as year,
  CAST('2024-12-01 00:00:00' as TIMESTAMP) as budget_timestamp,
  CASE
    WHEN UPPER(budget_dec_24_bud__input_currency) = 'NAN' THEN NULL
    ELSE budget_dec_24_bud__input_currency
  ...
  CASE
    WHEN UPPER(budget_dec_24__actuals) = 'NAN' THEN NULL
    ELSE budget_dec_24__actuals
