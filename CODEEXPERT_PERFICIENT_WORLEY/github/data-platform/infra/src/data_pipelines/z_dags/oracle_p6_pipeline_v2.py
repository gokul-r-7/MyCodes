...
projects = [str(d) for d in metadata[environment]['Project']['Id']]  # Convert Decimal objects to strings
data_type = metadata['dev']['Project']['data_type']
...
# Create DAG
with DAG(
    dag_id=f"oracle_p6_{environment}_data_pipeline_v2",
    schedule="0 2 1,15 * *",
    tags=["oracle_p6"],
