...
file_key = 'processed/Health_Score_Prod/Health_Score_Config/healthscore_dashboard.json'

raw_file_path= 's3://cci-dig-aicoe-data-sb/processed/Health_Score_Prod/Health_Score_Input/HS_Cleaned_Mar.csv'
...
second_output_path = "s3://cci-dig-aicoe-data-sb/processed/Health_Score_Prod/healthscore_actual_data/"
...
first_output_path = "s3://cci-dig-aicoe-data-sb/processed/Health_Score_Prod/healthscore_master/"
...
third_table_final_df['Date'] = pd.to_datetime(third_table_final_df['Date'], format='%Y/%m/%d')
...
third_output_path = "s3://cci-dig-aicoe-data-sb/processed/Health_Score_Prod/healthscore_percent_both/"
...
colour_indicators_df['create_dt'] = colour_indicators_df['create_dt'].astype(str)

# Ensure the numeric columns are in the correct type
colour_indicators_df['1st Quartile'] = colour_indicators_df['1st Quartile'].astype(float)
colour_indicators_df['3rd Quartile'] = colour_indicators_df['3rd Quartile'].astype(float)
# Repeat for other numeric columns as necessary.
...
fourth_output_path = "s3://cci-dig-aicoe-data-sb/processed/Health_Score_Prod/healthscore_calculations/"
