...
logger.info("AWS Glue Job Initialized")
...
job = Job(glueContext)
logger.info('Spark and Glue Context initialized')
...
def parse_data(
    logger.info("Entering function: parse_data")data):
    feature_groups = {}
...
def move_row(
    logger.info("Entering function: move_row")df, from_idx, to_idx):
...
def generate_hierarchy_id_grouped_by_os(
    logger.info("Entering function: generate_hierarchy_id_grouped_by_os")df):
...
def assign_parent_id(
    logger.info("Entering function: assign_parent_id")row):
...
def calculate_level_no(
    logger.info("Entering function: calculate_level_no")row):
...
def calculate_parent_id(
    logger.info("Entering function: calculate_parent_id")row, df):
...
def is_date_column(
    logger.info("Entering function: is_date_column")col_name):
    date_formats = ['%d-%m-%Y']
...
second_table_spark_df_transformed.
...
def calculate_percentage(
    logger.info("Entering function: calculate_percentage")df, datecolumns, metricid, parentid):
...
def calculate_both(
    logger.info("Entering function: calculate_both")df, metricid, parentid):
    """
...
# Show the updated DataFrame to verify the changes
first_table_spark_df_transformed.
...
# Show the updated DataFrame to verify the changes
third_table_spark_df_transformed.
...
def calculate_upper_lower(
    logger.info("Entering function: calculate_upper_lower")df, parent_column='parent_id'):
    ...
    def calculate_row(
    logger.info("Entering function: calculate_row")row):
...
def calculate_last7_and_30_days(
    logger.info("Entering function: calculate_last7_and_30_days")df):
...
def add_colour_indicators(
    logger.info("Entering function: add_colour_indicators")df):
    # Function to assign colour_indicator based on the logic
    def assign_colour_indicator(
    logger.info("Entering function: assign_colour_indicator")row):
    ...
    def assign_colour_indicator1(
    logger.info("Entering function: assign_colour_indicator1")row):
...
fourth_table_spark_df_transformed.
