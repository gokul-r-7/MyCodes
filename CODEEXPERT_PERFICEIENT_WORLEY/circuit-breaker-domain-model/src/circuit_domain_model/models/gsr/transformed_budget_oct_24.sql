...
{{
    config(
        ...
        custom_location=target.location ~ 'transformed_budget_oct_24/',
...
select
  'Oct' as month,
  '2024' as year,
  CAST('2024-10-01 00:00:00' as TIMESTAMP) as budget_timestamp,
  CASE
    WHEN UPPER(budget_oct_24__bud__input_currency) = 'NAN' THEN NULL
    ELSE budget_oct_24__bud__input_currency
  ...
  CASE
    WHEN UPPER(budget_oct_24__actuals) = 'NAN' THEN NULL
    ELSE budget_oct_24__actuals
