...
{{
    config(
        ...
        custom_location=target.location ~ 'transformed_budget_may_25/',
...
select
  'May' as month,
  '2025' as year,
  CAST('2025-05-01 00:00:00' as TIMESTAMP) as budget_timestamp,
  CASE
    WHEN UPPER(budget_may_25_bud__input_currency) = 'NAN' THEN NULL
    ELSE budget_may_25_bud__input_currency
  ...
  CASE
    WHEN UPPER(budget_may_25__actuals) = 'NAN' THEN NULL
    ELSE budget_may_25__actuals
