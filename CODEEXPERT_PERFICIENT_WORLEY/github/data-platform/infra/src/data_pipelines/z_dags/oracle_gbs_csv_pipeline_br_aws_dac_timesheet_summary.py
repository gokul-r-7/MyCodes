...
function_name ="dac_timesheet_summary"
...
datasets = ["br_aws_dac_timesheet_summary"]
...
# Create DAG
with DAG(
    dag_id=f"oracle_gbs_csv_{environment}_data_pipeline_br_aws_dac_timesheet_summary",
    schedule=None,
    tags=["oracle_gbs_csv"],
    ...
    def oracle_gbs_csv_sourcing():
        ...
        csv_task = GlueJobOperator(
            ...
            script_args={
                "--source_name": source_system_id,
                "--metadata_type": f"dac_timesheet_summary_csv#{source_system_id}",
                "--function_name": "dac_timesheet_summary_csv",
