...
payload = json.dumps({
          ...
          "obt_name": [],
        #   "obt_name": ["ecosys_control_account_fact_obt","ecosys_finance_fact_obt",
        #             "ecosys_project_data_availability","dim_ecosys_header"], 
          "db": "global_standard_reporting",
          "dag_name": "dbt_global_standard_reporting_project_control_dag_v2"
          })
...
profile_config = ProfileConfig(
    ...
    profile_mapping=RedshiftUserPasswordProfileMapping(
        ...
        profile_args={"schema": "project_control",
...
with DAG(
    dag_id="dbt_global_standard_reporting_project_control_dag_v2",
