...
{{
    config(
        ...
        custom_location=target.location ~ 'transformed_budget_april_25/',
...
select
  'Apr' as month,
  '2025' as year,
  CAST('2025-04-01 00:00:00' as TIMESTAMP) as budget_timestamp,
  CASE
    WHEN UPPER(budget_apr_25__bud__input_currency) = 'NAN' THEN NULL
    ELSE budget_apr_25__bud__input_currency
  ...
  CASE
    WHEN UPPER(budget_apr_25__actuals) = 'NAN' THEN NULL
    ELSE budget_apr_25__actuals
